...
<head>
	  ...
	  <!-- PAGE TITLE HERE -->
	  <title>Carntel Template | Blog</title>
...
<div class="page-wraper">
	  ...
	  <div class="page-content">
		    ...
		    <div class="wt-bnr-inr site-bg-dark  twm-primary-overlay-wrap"
			    style="background-image: url(../images/banner/banner-1.jpg);">
					   ...
					   <div class="section-content">
								  ...
								  <div class="masonry-item col-xl-4 col-lg-6 col-md-6 m-b30 wow fadeInDown"
									  data-wow-delay="0.2">
									    <div class="twm-lt-blog">
											 <div class="wt-post-media">
												   <a href="blog-detail.php"><img
															  src="../images/blog/latest/bg7.jpg"
															  alt=""></a>
											 </div>
											 <div class="twm-post-info-wrap">
												   <div class="post-date-wrap">
								  ...
								  <div class="masonry-item col-xl-4 col-lg-6 col-md-6 m-b30 wow fadeInDown"
									  data-wow-delay="0.2">
									    <div class="twm-lt-blog">
											 <div class="wt-post-media">
												   <a href="blog-detail.php"><img
															  src="../images/blog/latest/bg8.jpg"
															  alt=""></a>
											 </div>
											 <div class="twm-post-info-wrap">
												   <div class="post-date-wrap">
								  ...
								  <div class="masonry-item col-xl-4 col-lg-6 col-md-6 m-b30 wow fadeInDown"
									  data-wow-delay="0.2">
									    <div class="twm-lt-blog">
											 <div class="wt-post-media">
												   <a href="blog-detail.php"><img
															  src="../images/blog/latest/bg9.jpg"
															  alt=""></a>
											 </div>
											 <div class="twm-post-info-wrap">
												   <div class="post-date-wrap">
							...
							<div class="pagination-outer d-flex justify-content-center">
								  <div class="pagination-style1">
									    <ul class="clearfix">
											 <li class="prev"><a
														href="blog.php"><span> <i
																    class="fa-solid fa-chevron-left"></i> </span></a>
											 </li>
											 <li><a href="blog.php">1</a>
											 </li>
											 <li class="active"><a
														href="blog.php">2</a>
											 </li>
											 <li><a href="blog.php">3</a>
											 </li>
											 <li class="next"><a
														href="blog.php"><span> <i
