...
<head>
	  ...
	  <!-- PAGE TITLE HERE -->
	  <title>Carntel Template | Team</title>
...
<div class="page-wraper">
	  ...
	  <div class="page-content">
		    ...
		    <!-- Team SECTION START -->
		    <div class="section-full p-t150 p-b120 site-bg-white twm-team2-section-wrap">
				 <div class="container">

					   <div class="section-content">
							<!-- TITLE START-->
							<div class="section-head center">
								  <div class="twm-sm-title left">Team
									    Members
								  </div>
							...
							<div class="row">
								  ...
								  <!--One block-->
								  <div class="col-lg-3 col-md-6 col-sm-6 m-b30 wow fadeInDown"
									  data-wow-delay="0.2">
