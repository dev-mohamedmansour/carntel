...
<head>
	  ...
	  <!-- PAGE TITLE HERE -->
	  <title>Carntel Template | Home Page 2</title>
...
<div class="page-wraper">
	  ...
	  <!-- HEADER START -->
	  <header
		    class="site-header header-style-1 mobile-sider-drawer-menu light-hdr with-logo-bg-strip">
	  ...
	  <div class="page-content">
		    ...
		    <!--BANNER START-->
		    <div class="twm-home2-bnr"
			    style="background-image: url('images/main-slider/slide2/bg-pic1.jpg')">
				 ...
				 <div class="container">
					   <div class="twm-banner-left-content-section">
							<div class="twm-banner-left-content">
								  <div class="twm-sm-title left">
									    Premium
								  </div>
								  <h2 class="twm-banner-title">
									    <em>Your<span class="txt-type"
												   data-wait="3000"
												   data-words='["Choice", "Bike"]'></span></em>
									    <span>For</span>Rent
								  </h2>
								  <div class="twm-bnr-discription">
									    I must tell you that you can
									    also rent a bike of your
									    choice. And enjoy a serpentine
									    ride to the incredible
									    places of your choice.
								  </div>
								  <div class="twm-bnr-buttons">
									    <a href="cars-detail.php"
										  class="site-button-secondry btn-large">
											 <em>View Full
												   Detail</em>
									    </a>
									    <a href="cars-detail.php"
										  class="site-button  btn-large">
											 <em>Rent Now</em>
									    </a>
								  </div>
							</div>
					   ...
					   <div class="twm-banner-product-price">
							<div class="twm-product-name">harley
								  davidson
							</div>
		    ...
		    <div class="twm-search-section-wrap">
				 <div class="container">
					   <div class="twm-search-section-area">
							<h3 class="twm-s-section-title">Available for
								  rent</h3>
		    ...
		    <!--ACHIEVEMENT US SECTION START-->
		    <div class="section-full site-bg-white p-t150 p-b120 twm-achievement-section-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">
				 <div class="container">
					   <div class="row twm-achievement-section-bx">
							<div class="col-xl-5 col-lg-6 col-md-12">
								  <div class=" twm-achievement-section">
									    <!-- TITLE START-->
							...
							<div class="col-xl-7 col-lg-6 col-md-12">
								  <div class="twm-achievement-section-right">
									    <div class="row">
											 <div class="col-md-6 m-b30">
												   <div class="twm-left-with-icon">
														<div class="icon-media">
															  <img src="images/icons/rental.png"
																  alt=""
																  class="">
														</div>
														<span class="counter">4500</span>
														<em class="symble">+</em>
														<h3 class="icon-content-info">
															  Client
															  Served</h3>
												   </div>
											 </div>
											 ...
											 <div class="col-md-6 m-b30">
												   <div class="twm-left-with-icon">
														<div class="icon-media">
															  <img src="images/icons/car-insurance.png"
																  alt=""
																  class="">
														</div>
											 ...
											 <div class="col-md-6 m-b30">
												   <div class="twm-left-with-icon">
														<div class="icon-media">
															  <img src="images/icons/work-time.png"
																  alt=""
																  class="">
														</div>
		    ...
		    <!--CAR BRANDS US SECTION START-->
		    <div class="section-full site-bg-white twm-carbrands-section-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">

				 <div class="row twm-carbrands">
					   <div class="col-lg-6 col-md-12">
							<div class="twm-carbrands-l-pic">
								  <div class="twm-media">
					   ...
					   <div class="col-lg-6 col-md-12">
							<div class=" twm-carbrands-section">
								  <!-- TITLE START-->
								  <div class="section-head left">
									    <div class="twm-sm-title left">
											 Car Brands
									    ...
									    <h2 class="twm-large-title site-text-dark">
											 A Range Of Premium Brand
											 Bikes And Cars Available
											 For Rent
									    </h2>
								  </div>
								  <!-- TITLE END-->
								  <div class="twm-carbrands-list">
									    <ul>
											 <li>
		    ...
		    <!--CAR BRANDS SECTION END-->

		    <!--ABOUT US SECTION START-->
		    <div class="section-full site-bg-light twm-abus-section-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">
				 <div class="row">
					   <div class="col-lg-6 col-md-12">
							<div class=" twm-abus-st2-section">
								  ...
								  <div class="twm-abus2-left">
									    <div class="twm-abus-video">
											 <a href="https://vimeo.com/337649532"
											    class="mfp-video ">
					   ...
					   <div class="col-lg-6 col-md-12 twm-abus2-right-pic"
						   style="background-image:url(images/ab-us.jpg) ">
		    ...
		    <div class="section-full p-t150 p-b120 site-bg-white twm-step-towards-section-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">
				 <div class="container">

					   <!-- TITLE START-->
					   <div class="section-head center">
							<div class="twm-sm-title left">One step
								  towards you
							</div>
							<h2 class="twm-large-title site-text-dark">
								  Let's Your Adventure Begin</h2>
					   </div>
					   <!-- TITLE END-->
					   ...
					   <div class="section-content">
							<div class="row twm-step-towards-section">
								  ...
								  <div class="col-lg-4 col-md-6 m-b30">
									    <div class="twm-icon-style-left2 large-set">
											 <div class="twm-media">
								  ...
								  <div class="col-lg-4 col-md-6 m-b30">
									    <div class="twm-icon-style-left2 large-set">
											 <div class="twm-media">
												   <img src="images/icons/customer-support.png"
													   alt="image">
											 </div>
											 <div class="twm-content">
												   <h3 class="twm-title">
								  ...
								  <div class="col-lg-4 col-md-6 m-b30">
									    <div class="twm-icon-style-left2 large-set">
											 <div class="twm-media">
												   <img src="images/icons/parking-area.png"
													   alt="image">
											 </div>
											 <div class="twm-content">
												   <h3 class="twm-title">
		    ...
		    <div class="section-full p-t150 p-b120 site-bg-light twm-vehicle-fleet2-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">
				 <div class="container">
					   ...
					   <!-- TITLE START-->
					   <div class="section-head center ">
							<div class="twm-sm-title left">Choose your
								  car
							</div>
							<h2 class="twm-large-title site-text-dark">
					   ...
					   <div class="section-content">
							<div class="owl-carousel twm-vehicle-fleet2-carousel m-b30">

								  <!--One block-->
								  <div class="item">
									    <div class="twm-vehicle-fleet-large-bx">
											 <div class="twm-media">
												   <div class="twm-media-pic">
														<img src="images/large-v-fleet/pic1.jpg"
															alt="image">
												   </div>
											 </div>
											 <div class="twm-vehicle-fleet-content">
												   ...
												   <ul class="twm-vehicle-facility">
														...
														<li><span><img src="images/icons/bag.png"
																	alt="Image"></span>4
															  Bags
														</li>
														<li><span><img src="images/icons/car.png"
																	alt="Image"></span>Exotic
															  car
														</li>
												   </ul>
								  ...
								  <div class="item">
									    <div class="twm-vehicle-fleet-large-bx">
											 <div class="twm-media">
												   <div class="twm-media-pic">
														<img src="images/large-v-fleet/pic2.jpg"
															alt="image">
												   </div>
											 </div>
											 <div class="twm-vehicle-fleet-content">
								  ...
								  <div class="item">
									    <div class="twm-vehicle-fleet-large-bx">
											 <div class="twm-media">
												   <div class="twm-media-pic">
														<img src="images/large-v-fleet/pic3.jpg"
															alt="image">
												   </div>
											 </div>
											 <div class="twm-vehicle-fleet-content">
		    ...
		    <div class="section-full site-bg-white p-t150 p-b120 twm-w-chooseus2-section-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">
				 <div class="container">
					   <div class="row twm-w-chooseus2-section">
							<div class="col-lg-5 col-md-12">
								  ...
								  <div class="twm-list-icon-style2">
									    <ul>
											 <li>
												   <div class="twm-list-icon-style-bx2">
														<div class="twm-icon-bx">
                                                <span>
                                                    <img src="images/w-choose-icon/icon-1.png"
											  alt="image">
                                                </span>
														</div>
											 ...
											 <li>
												   <div class="twm-list-icon-style-bx2">
														<div class="twm-icon-bx">
                                                <span>
                                                    <img src="images/w-choose-icon/icon-2.png"
											  alt="image">
                                                </span>
														</div>
														<div class="twm-icon-bx-detail">
											 ...
											 <li>
												   <div class="twm-list-icon-style-bx2">
														<div class="twm-icon-bx">
                                                <span>
                                                    <img src="images/w-choose-icon/icon-3.png"
											  alt="image">
                                                </span>
														</div>
														<div class="twm-icon-bx-detail">
											 ...
											 <li>
												   <div class="twm-list-icon-style-bx2">
														<div class="twm-icon-bx">
                                                <span>
                                                    <img src="images/w-choose-icon/icon-4.png"
											  alt="image">
                                                </span>
														</div>
														<div class="twm-icon-bx-detail">
							...
							<div class="col-lg-7 col-md-12">
								  <div class="twm-w-chooseus2-media">
									    <div class="twm-media">
											 <img src="images/need-h-pic2.jpg"
												 alt="Image">
									    </div>
									    <div class="twm-need-help-bx2">
		    ...
		    <div class="section-full site-bg-light twm-how-it-work-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">
				 <div class="section-content">
		    ...
		    <div class="section-full p-t150 p-b120 site-bg-white twm-categories2-section-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">
				 <div class="container">
					   ...
					   <div class="section-content">
							<div class="owl-carousel twm-categories2-carousel next-prev-top-right m-b30">

								  <!--1 block-->
								  <div class="item">
									    <div class="twm-categories2-type-wrap">
											 <div class="twm-categories2-type">
												   <div class="twm-media-wrap">
														<div class="twm-media">
															  <img src="images/types-vehicles/SUV.png"
																  alt="Image">
														</div>
												   </div>
								  ...
								  <div class="item">
									    <div class="twm-categories2-type-wrap">
											 <div class="twm-categories2-type">
												   <div class="twm-media-wrap">
														<div class="twm-media">
															  <img src="images/types-vehicles/sedan.png"
																  alt="Image">
														</div>
												   </div>
												   <div class="twm-media-link">
								  ...
								  <div class="item">
									    <div class="twm-categories2-type-wrap">
											 <div class="twm-categories2-type">
												   <div class="twm-media-wrap">
														<div class="twm-media">
															  <img src="images/types-vehicles/coupe-2.png"
																  alt="Image">
														</div>
												   </div>
												   <div class="twm-media-link">
								  ...
								  <div class="item">
									    <div class="twm-categories2-type-wrap">
											 <div class="twm-categories2-type">
												   <div class="twm-media-wrap">
														<div class="twm-media">
															  <img src="images/types-vehicles/hatchback.png"
																  alt="Image">
														</div>
												   </div>
												   <div class="twm-media-link">
								  ...
								  <div class="item">
									    <div class="twm-categories2-type-wrap">
											 <div class="twm-categories2-type">
												   <div class="twm-media-wrap">
														<div class="twm-media">
															  <img src="images/types-vehicles/convertible-car.png"
																  alt="Image">
														</div>
												   </div>
												   <div class="twm-media-link">
														<a href="cars-detail.php"
														   class="twm-media-link-content">Convertible</a>
												   </div>
											 </div>
									    </div>
								  </div>
								  ...
								  <div class="item">
									    <div class="twm-categories2-type-wrap">
											 <div class="twm-categories2-type">
												   <div class="twm-media-wrap">
														<div class="twm-media">
															  <img src="images/types-vehicles/hybrid-car.png"
																  alt="Image">
														</div>
												   </div>
												   <div class="twm-media-link">
		    ...
		    <div class="section-full p-t150  p-b120 site-bg-dark twm-testimonial-section-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">
				 <div class="container">
							...
							<div class="owl-carousel twm-blog-carousel next-prev-top-right m-b30">
								  ...
								  <div class="item">
									    <div class="twm-testimonial2 drk-view">
											 <div class="twm-testimonial-head">
												   <div class="media-pic">
														<img src="images/testimonial/pic1.jpg"
															alt="Image">
												   </div>
								  ...
								  <div class="item">
									    <div class="twm-testimonial2 drk-view">
											 <div class="twm-testimonial-head">
												   <div class="media-pic">
														<img src="images/testimonial/pic2.jpg"
															alt="Image">
												   </div>
												   <div class="twm-author-detail">
														<h3 class="twm-title">
								  ...
								  <div class="item">
									    <div class="twm-testimonial2 drk-view">
											 <div class="twm-testimonial-head">
												   <div class="media-pic">
														<img src="images/testimonial/pic3.jpg"
															alt="Image">
												   </div>
												   <div class="twm-author-detail">
														<h3 class="twm-title">
		    ...
		    <div class="section-full p-t150 p-b120 site-bg-white twm-blog-section-wrap wow fadeInDown"
			    data-wow-offset="100" data-wow-delay="0.2">
				 <div class="container">
					   ...
					   <!-- TITLE START-->
					   <div class="section-head center ">
							<div class="twm-sm-title left">From the
								  Blog
							</div>
							<h2 class="twm-large-title site-text-dark">
								  Car And Bike Rental News</h2>
					   </div>
					   <!-- TITLE END-->
							...
							<div class="owl-carousel twm-blog-carousel m-b30">
									    ...
									    <div class="twm-blog-grid-2">
											 <div class="wt-post-media">
												   <a href="blog-detail.php"><img
															  src="images/blog/blog-grid-2/pic-1.jpg"
															  alt=""></a>
											 </div>
								  ...
								  <div class="item">
									    <div class="twm-blog-grid-2">
											 <div class="wt-post-media">
												   <a href="blog-detail.php"><img
															  src="images/blog/blog-grid-2/pic-2.jpg"
															  alt=""></a>
											 </div>
											 <div class="twm-post-info-wrap">
												   <div class="post-date-wrap">
								  ...
								  <div class="item">
									    <div class="twm-blog-grid-2">
											 <div class="wt-post-media">
												   <a href="blog-detail.php"><img
															  src="images/blog/blog-grid-2/pic-3.jpg"
															  alt=""></a>
											 </div>
											 <div class="twm-post-info-wrap">
												   <div class="post-date-wrap">
								  ...
								  <div class="item">
									    <div class="twm-blog-grid-2">
											 <div class="wt-post-media">
												   <a href="blog-detail.php"><img
															  src="images/blog/blog-grid-2/pic-4.jpg"
															  alt=""></a>
											 </div>
											 <div class="twm-post-info-wrap">
												   <div class="post-date-wrap">
								  ...
								  <div class="item">
									    <div class="twm-blog-grid-2">
											 <div class="wt-post-media">
												   <a href="blog-detail.php"><img
															  src="images/blog/blog-grid-2/pic-5.jpg"
															  alt=""></a>
											 </div>
											 <div class="twm-post-info-wrap">
												   <div class="post-date-wrap">
								  ...
								  <div class="item">
									    <div class="twm-blog-grid-2">
											 <div class="wt-post-media">
												   <a href="blog-detail.php"><img
															  src="images/blog/blog-grid-2/pic-6.jpg"
															  alt=""></a>
											 </div>
											 <div class="twm-post-info-wrap">
												   <div class="post-date-wrap">
							...
							<div class="col-xl-4 col-lg-4">
								  ...
								  <div class="widget widget_about">
									    ...
									    <div class="f-about-info">
											 We offer a range of the
											 finest and most premium
											 cars and bikes on rent.
									    </div>
									    <ul class="ftr-list">
											 <li>
												   <i class="feather feather-phone-call"></i><a
														href="tel:1236540214">123
														654
														0214</a>
											 </li>
											 <li>
												   <i class="feather feather-mail"></i>carntelinfo@gmail.com
											 </li>
											 <li>
												   <i class="feather feather-home"></i>55/11
												   ronin tower New
												   York
											 </li>
									    </ul>
									    <div class="twm-social">
											 <ul>
												   ...
												   <li>
														<a href="https://www.x.com"><i
																    class="feather feather-facebook"></i></a>
												   </li>
												   <li>
														<a href="https://www.instagram.com"><i
																    class="feather feather-instagram"></i></a>
												   </li>
												   <li>
											 ...
											 <div class="twm-nl-section">
												   <form>
														<div class="ftr-nw-form">
															  <input name="news-letter"
																    class="form-control"
																    placeholder="Email address..."
																    type="text">
															  <button
																    class="ftr-nw-subcribe-btn">
																    <i class="feather feather-arrow-up-right"></i>
															  </button>
														</div>
												   </form>
											 </div>
		    ...
		    <div class="footer-bottom">
				 <div class="footer-bottom-info">
					   <div class="footer-copy-right">
							<span class="copyrights-text">© 2024<span
									    class="site-text-primary">Carntel</span> All  rights reserved.</span>
					   </div>
				 </div>
		    </div>
