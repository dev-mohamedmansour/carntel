...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Carntel Template | Cars Grid 4</title>
...
<body>
	...
	<div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <!-- INNER PAGE BANNER -->
            <div class="wt-bnr-inr twm-inner-banner-s-bar site-bg-dark  twm-primary-overlay-wrap" style="background-image: url(images/banner/banner-6.jpg);">
                                ...
                                <div class="container">
                                    ...
                                    <div class="twm-vehicle-search-section">
                                            ...
                                            <div class="twm-vehicle-search-btn">
                                                <a href="cars-grid-4.php" class="site-button">
                                                    <em>Find A Car</em>
                                                </a>
                                            </div>
            ...
            <!-- Team SECTION START -->
            <div class="section-full p-t150 site-bg-white twm-cars4-section-wrap">
                <div class="container">
                        ...
                        <div class=" twm-cars-section m-b30">
                            ...
                            <div class="pagination-outer d-flex justify-content-center">
                                <div class="pagination-style1">
                                    <ul class="clearfix">
                                        <li class="prev"><a href="cars-grid-4.php"><span> <i class="fa-solid fa-chevron-left"></i> </span></a></li>
                                        <li><a href="cars-grid-4.php">1</a></li>
                                        <li class="active"><a href="cars-grid-4.php">2</a></li>
                                        <li><a href="cars-grid-4.php">3</a></li>
                                        <li class="next"><a href="cars-grid-4.php"><span> <i class="fa-solid fa-chevron-right"></i> </span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="owl-carousel home-client-carousel3 owl-btn-vertical-center">
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                ...
                                <a href="cars-grid-4.php"><img src="images/client-logo/dark/w1.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="cars-grid-4.php"><img src="images/client-logo/dark/w2.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="cars-grid-4.php"><img src="images/client-logo/dark/w3.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="cars-grid-4.php"><img src="images/client-logo/dark/w4.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="cars-grid-4.php"><img src="images/client-logo/dark/w5.png" alt=""></a></div>
                            </div>
                        </div>
                        ...
                        <div class="item">
                            <div class="ow-client-logo">
                                <div class="client-logo client-logo-media">
                                <a href="cars-grid-4.php"><img src="images/client-logo/dark/w6.png" alt=""></a></div>
                            </div>
                        </div>
