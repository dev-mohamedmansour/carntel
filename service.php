...
<head>
	  ...
	  <!-- PAGE TITLE HERE -->
	  <title>Carntel Template | Services</title>
...
<div class="page-wraper">
	  ...
	  <div class="page-content">
		    ...
		    <div class="wt-bnr-inr site-bg-dark  twm-primary-overlay-wrap"
			    style="background-image: url(images/banner/banner-13.jpg);">
		    ...
		    <div class="section-full site-bg-white twm-abus3-section-wrap wow fadeInDown"
							...
							<div class="row twm-step-towards-section">
								  ...
								  <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
									    <div class="twm-facilities-bx">
											 <div class="twm-media">
												   <img src="images/icons/courier.png"
													   alt="image">
											 </div>
								  ...
								  <div class="col-lg-3 col-md-6 col-sm-6 m-b30">
									    <div class="twm-facilities-bx">
											 <div class="twm-media">
												   <img src="images/icons/biological.png"
													   alt="image">
											 </div>
											 <div class="twm-content">
												   <h3 class="twm-title">
