...
<head>
	  ...
	  <!-- PAGE TITLE HERE -->
	  <title>Carntel Template | Testimonials</title>
...
<div class="page-wraper">
	  ...
	  <div class="page-content">
		    ...
		    <div class="wt-bnr-inr site-bg-dark  twm-primary-overlay-wrap"
			    style="background-image: url(images/banner/banner-5.jpg);">
		    ...
		    <!-- Testimonial Grid SECTION START -->
		    <div class="section-full p-t150 p-b120 site-bg-white twm-testimonial2-section-wrap">
				 <div class="container">
					   ...
					   <div class="section-content">
							...
							<div class="row">
								  ...
								  <!--One block-->
								  <div class="col-xl-4 col-lg-6 col-md-6  m-b30 wow fadeInDown"
									  data-wow-delay="0.2">
