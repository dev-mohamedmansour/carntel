...
<head>
	  ...
	  <!-- PAGE TITLE HERE -->
	  <title>Carntel Template | Gallery</title>
...
<div class="page-wraper">
	  ...
	  <div class="page-content">
		    ...
		    <div class="wt-bnr-inr site-bg-dark  twm-primary-overlay-wrap"
			    style="background-image: url(images/banner/banner-9.jpg);">
		    ...
		    <div class="section-full site-bg-white p-t150 p-b120 twm-portfolio-wrap  wow fadeInDown"
				 ...
				 <div class="container">
					   ...
					   <div class="filter-navigation-wrap p-b30">
							<ul class="filter-navigation masonry-filter clearfix">
								  ...
								  <li><a class=" btn-inline "
									    data-filter=".cat-1" href="#">Luxury</a>
								  </li>
								  <li><a class=" btn-inline "
									    data-filter=".cat-2" href="#">Cars</a>
								  </li>
								  <li><a class=" btn-inline "
									    data-filter=".cat-3" href="#">Sports
											 Cars</a></li>
								  <li><a class=" btn-inline "
									    data-filter=".cat-4" href="#">Suv</a>
								  </li>
							</ul>
					   </div>
					   <!-- Filter Nav END -->
					   ...
					   <ul class="masonry-outer mfp-gallery work-grid row clearfix list-unstyled m-b0">
							...
							<!-- COLUMNS 1 -->
							<li class="masonry-item cat-2 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic1.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic1.jpg">
											 <img src="images/vehicle-2/pic1.jpg"
												 alt="">
											 <span class="icon-view"><i
														class="feather feather-maximize"></i></span>
									    </a>
									    <div class="twm-gallery-info">
											 <h3 class="twm-title">
												   Jeep
												   Renegade</h3>
									    </div>
							...
							<!-- COLUMNS 2 -->
							<li class="masonry-item cat-1 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic2.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic2.jpg">
							...
							<!-- COLUMNS 3 -->
							<li class="masonry-item cat-3 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic3.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic3.jpg">
							...
							<!-- COLUMNS 4 -->
							<li class="masonry-item cat-4 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic4.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic4.jpg">
							...
							<!-- COLUMNS 5 -->
							<li class="masonry-item cat-5 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic5.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic5.jpg">
							...
							<li class="masonry-item cat-4 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic6.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic6.jpg">
							...
							<li class="masonry-item cat-2 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic7.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic7.jpg">
							...
							<li class="masonry-item cat-1 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic8.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic8.jpg">
							...
							<li class="masonry-item cat-3 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic9.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic9.jpg">
							...
							<li class="masonry-item cat-4 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic10.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic10.jpg">
											 <img src="images/vehicle-2/pic10.jpg"
												 alt="">
											 <span class="icon-view"><i
														class="feather feather-maximize"></i></span>
									    </a>
							...
							<li class="masonry-item cat-5 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic11.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic11.jpg">
											 <img src="images/vehicle-2/pic11.jpg"
												 alt="">
											 <span class="icon-view"><i
														class="feather feather-maximize"></i></span>
									    </a>
							...
							<li class="masonry-item cat-4 col-lg-4 col-md-6 m-b30">
								  <div class="twm-gallery-section">
									    <a class="elem media"
										  href="images/vehicle-2/pic12.jpg"
										  data-lcl-author=""
										  data-lcl-thumb="images/vehicle-2/pic12.jpg">
											 <img src="images/vehicle-2/pic12.jpg"
												 alt="">
											 <span class="icon-view"><i
														class="feather feather-maximize"></i></span>
									    </a>
