...
<head>
	  ...
	  <!-- PAGE TITLE HERE -->
	  <title>Carntel Template | About Us</title>
...
<div class="page-wraper">
	  ...
	  <div class="page-content">
			 ...
			 <!-- INNER PAGE BANNER -->
			 <div class="wt-bnr-inr site-bg-dark  twm-primary-overlay-wrap" style="background-image: url(images/banner/banner-10.jpg);">
										...
										<div class="item">
											  <div class="twm-team-section">
													 <div class="twm-team-info">
															<a class="twm-l-title" href="team-detail.php">
																  <h2 class="twm-title">Kevin Martin</h2>
															</a>
															<div class="twm-s-title">Sales Consultant</div>
													 </div>
					...
					<div class="container">
						  ...
						  <div class="row">
								 <div class="col-lg-6 col-md-12">
										...
										<div class="section-head left ">
											  <div class="twm-sm-title left">Testimonial</div>
											  <h2 class="twm-large-title site-text-white">What Our Customers Say</h2>
										</div>
										<!-- TITLE END-->
								 </div>
						  </div>
			 ...
			 <div class="section-full site-bg-light twm-abus-section-wrap wow fadeInDown" data-wow-offset="100" data-wow-delay="0.2">
					<div class="row">
						  <div class="col-lg-6 col-md-12">
								 <div class=" twm-abus-st2-section">
										...
										<div class="twm-btn-left">
											  <a href="about-us.php" class="site-button">
													 <em>Read More</em>
											  </a>
										</div>
						  ...
						  <div class="col-lg-6 col-md-12 twm-abus2-right-pic" style="background-image:url(images/ab-us.jpg) ">
